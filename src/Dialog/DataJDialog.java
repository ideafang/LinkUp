...
public class DataJDialog extends JDialog {
	private JTextField time = new JTextField(Data.timeCount+"");
	private JTextField refresh = new JTextField(Data.refreshCountAll+"");
	private JTextField prompt = new JTextField(Data.promptCountAll+"");
	private JButton buttonSure = new JButton("确定");
	private JButton buttonCancel = new JButton("取消");
	MainFrame frame;

	public DataJDialog(MainFrame frame) {
		super(frame);
		this.frame = frame;
	...
	public void initEvent() {
		...
		buttonSure.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				dispose(); //销毁对话框
				Data.timeCount = timeChange;
				Data.refreshCountAll = refreshChange;
				Data.promptCountAll = promptChange;
				frame.restartGame();
			}
		});
